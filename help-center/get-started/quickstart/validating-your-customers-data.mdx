...
Templates help you validate your customer's data automatically. They define what "good" data looks like, so the system can identify problems.
...
Go to [vern.so/templates](https://app.vern.so/templates) and click "Create template." Upload a CSV file with sample clean data—this could be data from a previous customer or an example of what you expect.
...
5. Use Chat to fix any issues that were flagged
6. Your data is now clean and ready to use

## Next Steps

After validating your data, you can [clean any remaining messy data](/help-center/get-started/quickstart/cleaning-your-customers-messy-data) using Chat.
