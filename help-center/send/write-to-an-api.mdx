...
It's the no-code alternative to [webhooks](/migration-api/webhooks): instead of standing up an endpoint that catches Vern's payload, you let Vern call your existing API directly.
...
- [Webhooks](/migration-api/webhooks) — the build-your-own-endpoint alternative.
