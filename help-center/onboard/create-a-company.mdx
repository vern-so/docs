...
<Tip>
  Building this into your product? You can create a company, workbook, and magic link in one API call. See [Provision a company](/migration-api/provision-a-company).
</Tip>
