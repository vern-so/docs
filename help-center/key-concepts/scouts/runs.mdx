...
Single Runs are perfect when you want to scrape a single report or item. For example, if you want to scrape a single Employees report, you would create a single Run rather than iterating through each Employee entry on a page.
