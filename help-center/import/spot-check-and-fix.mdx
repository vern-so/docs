...
The chat uses your [template](/help-center/import/templates)'s column descriptions and validation rules to know what good data looks like. The better your templates, the better chat's results. If chat is consistently misinterpreting a column, fix the column's description.

## Next

- [How import works](/help-center/import/how-it-works) — to avoid needing to spot-check, get the agent's input right.
- [Templates](/help-center/import/templates) — sharper rules = fewer fixes needed.
