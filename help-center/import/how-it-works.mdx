...
You start with a file (CSV, Excel, PDF, or whatever Scouts pulled). You end with rows that pass your [template](/help-center/import/templates) rules and are ready to send to your app.
...
<Steps>
  ...
  <Step title="Clarify">
    ...
    For unknowns the agent can resolve itself, it runs a web search (via Exa) instead of asking you. The goal is to ask only the questions you actually need to answer.
  </Step>
...
- [Templates](/help-center/import/templates) — define what the agent is mapping to.
