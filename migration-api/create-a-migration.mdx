...
A new migration starts in `awaiting_files` — your next step is to
[upload files](/migration-api/upload-files).
...
- [Start a run](/migration-api/start-a-run) — generate a preview once files are uploaded.
