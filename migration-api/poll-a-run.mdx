...
<ResponseField name="report.coverage" type="object | null">
  ...
  Coverage reports **statistics only** — fill rates and distinct counts, never
  sample cell values. It tells you *how much* landed in a column, not *what* is
  in it. To see actual values, [export the sheet](/migration-api/export-csv).
</ResponseField>
