...
This is the **file** export path and the complete v1 delivery story: download
the CSV, or relay it into your own storage bucket (below). Pushing rows into a
destination **API** instead is [Export to a destination](/migration-api/export-to-destination),
which lands in v2.
