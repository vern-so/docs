...
<Tabs>
  <Tab title="Webhooks (Recommended)">
    Configure a [webhook](/guides/essentials/webhooks) endpoint in your application to receive run completion events. This is the recommended approach as it eliminates the need for polling and provides real-time updates.
