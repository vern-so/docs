...
You can manage your webhooks through the [Vern Dashboard](https://app.vern.so/webhooks), where you can:
...
- `profile.linked` - Triggered when a company is linked via magic link
...
- Set up webhook endpoints in your [Vern Dashboard](https://app.vern.so/webhooks)
