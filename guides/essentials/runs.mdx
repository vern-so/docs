...
Runs represent a specific execution instance of a [Task](/guides/essentials/tasks). When you want Vern to perform an action defined by a Task, you create a Run.
...
- `profileId` (optional): User-specified UID for a company linked via magic link
...
Now that you understand Runs, explore the [Tasks](/guides/essentials/tasks) documentation to learn how to define the actions that your runs will execute. You can also learn about [Webhooks](/guides/essentials/webhooks) to receive notifications when runs complete.
